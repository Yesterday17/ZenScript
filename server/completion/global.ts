...
export function GlobalCompletion(): CompletionItem[] {
  return [
    ...
    { label: 'frigginClass', kind: CompletionItemKind.Keyword },
    { label: 'zenConstructor', kind: CompletionItemKind.Keyword },
    { label: 'frigginConstructor', kind: CompletionItemKind.Keyword },
